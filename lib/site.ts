...
export const publicSitemapRoutes: SitemapRouteEntry[] = [
  ...
  { path: "/school/acting-and-performance", changeFrequency: "monthly", priority: 0.85 },
  { path: "/school/scriptwriting", changeFrequency: "monthly", priority: 0.85 },
  { path: "/school/film-directing", changeFrequency: "monthly", priority: 0.85 },
  { path: "/school/film-production", changeFrequency: "monthly", priority: 0.85 },
